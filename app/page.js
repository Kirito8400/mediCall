        ...
        <div className="px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <Badge
                variant="outline"
                className="bg-[#38B6FF]/30 border-emerald-700/30 px-4 py-2 text-emerald-400 text-sm font-medium"
              >
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardHeader className="pb-2">
                  <div className="bg-[#38B6FF]/20 p-3 rounded-lg w-fit mb-4">
                    {feature.icon}
                  </div>
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge
              variant="outline"
              className="bg-[#38B6FF]/30 border-emerald-700/30 px-4 py-1 text-emerald-400 text-sm font-medium mb-4"
            >
                ...
                <ul className="space-y-3">
                  {creditBenefits.map((benefit, index) => (
                    <li key={index} className="flex items-start">
                      <div className="mr-3 mt-1 bg-[#38B6FF]/20 p-1 rounded-full">
                        <svg
              ...
              >
                <CardContent className="pt-6">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#38B6FF]/20 flex items-center justify-center mr-4">
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-r from-emerald-900/30 to-emerald-950/20 border-emerald-800/20">
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="flex flex-col items-center text-center m-auto relative z-10">
